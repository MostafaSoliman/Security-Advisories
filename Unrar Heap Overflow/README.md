...
Final
-------
The issue was reported to MITRE to assign a CVE, they responded that vulnerabilities that require payload to be delivered via config files are out of scope.
